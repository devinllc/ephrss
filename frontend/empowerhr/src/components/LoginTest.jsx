...
import { authenticatedFetch, parseJsonResponse, authenticatedPostWithTokenInBody, loginEmployee, loginAdmin, API_BASE_URL } from '../utils/api';
...
const LoginTest = () => {
    ...
    const testAttendanceEndpoint = async () => {
        ...
        try {
            const response1 = await fetch('${API_BASE_URL}/attendence/status', {
                method: 'GET',
                credentials: 'include',
                headers: {
        ...
        try {
            const response2 = await axios({
                method: 'get',
                url: '${API_BASE_URL}/attendence/status',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                },
        ...
        try {
            const response3 = await fetch(`${API_BASE_URL}/attendence/status?token=${token}`, {
                method: 'GET',
                credentials: 'include'
            });
        ...
        try {
            const response5 = await fetch('${API_BASE_URL}/attendence/status', {
                method: 'GET',
                headers: {
        ...
        try {
            const response6 = await fetch(`${API_BASE_URL}/attendence/status/token/${token}`, {
                method: 'GET'
            });
        ...
        try {
            const response7 = await fetch('${API_BASE_URL}/attendence/status', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
